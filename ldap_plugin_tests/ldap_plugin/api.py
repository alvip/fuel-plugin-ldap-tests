...
from ldap_plugin_tests.helpers import checkers
from ldap_plugin_tests.helpers import helpers
from ldap_plugin_tests.helpers import remote_ops
from ldap_plugin_tests.murano_plugin import plugin_settings


class LdapPluginApi(object):
    """Class to manage LDAP plugin."""
    ...
    def check_plugin_online(self):
        ...
        test_name = ('fuel_health.tests.tests_platform.test_ldap_linux.'
                     'LdapDeployLinuxServicesTests.'
